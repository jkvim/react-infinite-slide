...
var EventSubscription = __webpack_require__(55);
...
var _reactGithubCorner = __webpack_require__(33);
...
function App() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      _src.Slides,
      { arrowLeft: _react2.default.createElement(_src.ArrowLeft, null), arrowRight: _react2.default.createElement(_src.ArrowRight, null), dots: _react2.default.createElement(_src.Dots, { length: 3 }) },
      _react2.default.createElement(
        'div',
        { className: 'one', style: { background: '#bdff70', width: '500px', height: '300px' } },
        _react2.default.createElement(
          'h1',
          { style: styles.h1 },
          '1'
      ...
      _react2.default.createElement(
        'div',
        { className: 'two', style: { background: '#f09bfd', width: '500px', height: '300px' } },
        _react2.default.createElement(
          'h1',
          { style: styles.h1 },
          '2'
      ...
      _react2.default.createElement(
        'div',
        { className: 'three', style: { background: '#ffa500', width: '500px', height: '300px' } },
        _react2.default.createElement(
          'h1',
          { style: styles.h1 },
          '3'
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var invariant=__webpack_require__(1);var React=__webpack_require__(3);var warning=__webpack_require__(4);var ExecutionEnvironment=__webpack_require__(9);var _assign=__webpack_require__(5);var emptyFunction=__webpack_require__(2);var checkPropTypes=__webpack_require__(27);var getActiveElement=__webpack_require__(10);var shallowEqual=__webpack_require__(11);var containsNode=__webpack_require__(12);var emptyObject=__webpack_require__(6);var hyphenateStyleName=__webpack_require__(29);var camelizeStyleName=__webpack_require__(31);// Relying on the `invariant()` implementation lets us
// have preserve the format and params in the www builds.
...
var GithubCorner = function (_Component) {
  ...
  _createClass(GithubCorner, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('a', { href: href, className: 'github-corner' }, _react2.default.createElement('svg', { width: width, height: height, viewBox: '0 0 250 250', style: mainStyle }, _react2.default.createElement('path', { className: 'octo-banner', d: pathBanner, fill: bannerColor }), _react2.default.createElement('path', { className: 'octo-arm', d: pathArm, style: armStyle }), _react2.default.createElement('path', { className: 'octo-body', d: pathBody })));
    }
  }]);
...
var _dots = __webpack_require__(37);

var _dots2 = _interopRequireDefault(_dots);

var _slides = __webpack_require__(41);
...
exports.ArrowLeft = _arrows.ArrowLeft;
exports.ArrowRight = _arrows.ArrowRight;
...
function Arrow(_ref) {
  ...
  return _react2.default.createElement(
    'div',
    { className: 'arrow-' + direction, style: style.wrapper, onClick: onClick },
    _react2.default.createElement('div', { style: style.arrow })
  );
}

var ArrowLeft = function ArrowLeft(_ref2) {
  var onClick = _ref2.onClick;
  return _react2.default.createElement(Arrow, { direction: 'left', onClick: onClick });
};

var ArrowRight = function ArrowRight(_ref3) {
  var onClick = _ref3.onClick;
  return _react2.default.createElement(Arrow, { direction: 'right', onClick: onClick });
};
  ...
  _createClass(Dots, [{
    ...
    value: function getDots() {
      ...
      var _loop = function _loop(i) {
        ...
        if (i === _this2.props.activeDot) {
          style.background = '#FFFFFF';
        }

        dots.push(_react2.default.createElement('li', { onClick: function onClick() {
            return _this2.onClick(i);
          }, style: style, key: i }));
      };

      for (var i = 0; i < this.props.length || 0; i++) {
        _loop(i);
      }
      return dots;
    }
...
Dots.propTypes = {
  activeDot: _propTypes2.default.number,
...
var _fbemitter = __webpack_require__(53);
...
var Slides = function (_React$Component) {
  ...
  function Slides() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Slides.__proto__ || Object.getPrototypeOf(Slides)).call.apply(_ref, [this].concat(args))), _this), _this.emitter = new _fbemitter.EventEmitter(), _this.animationQueue = [], _this.playing = false, _this.state = { active: _this.maxLength, playAnimation: true }, _this.getNextJob = function () {
      var nextStep = _this.animationQueue.pop();
      if (nextStep && !_this.playing) {
        _this.playing = true;
        _this.navigationTo(nextStep);
      }
    }, _this.caculateActive = function (increment) {
      return _this.state.active + increment;
    }, _this.navigationTo = function (nextStep) {
      var active = _this.caculateActive(nextStep);
      var playAnimation = true;
      if (active > _this.maxLength) {
        active = 0;
        playAnimation = false;
      }
      if (active === -1) {
        active = _this.maxLength;
        playAnimation = false;
      }
      _this.setState({
        active: active,
    ...
    }, _this.pushToQueue = function (nextStep) {
      _this.animationQueue.push(nextStep);
      _this.notifyWorker();
    }, _this.notifyWorker = function () {
      _this.emitter.emit(EVENT.NOTIFY_WOKER);
    }, _this.handleSlideToLeft = function () {
      return _this.pushToQueue(-1);
    }, _this.handleSlideToRight = function () {
      return _this.pushToQueue(1);
    }, _this.handleTransitionEnd = function () {
      _this.playing = false;
      _this.notifyWorker();
    }, _this.sildeStyle = function (index) {
      var position = _this.atLast && index === 0 ? _this.maxLength : index;
      return {
        position: 'absolute',
        left: position + '00%'
      };
      ...
      var _this$state = _this.state,
          ...
          playAnimation = _this$state.playAnimation;
      ...
      var arrowLeft = _this.props.arrowLeft;

      return arrowLeft ? _react2.default.cloneElement(arrowLeft, {
        onClick: _this.handleSlideToLeft
      }) : null;
    }, _this.renderArrowRight = function () {
      var arrowRight = _this.props.arrowRight;

      return arrowRight ? _react2.default.cloneElement(arrowRight, {
        onClick: _this.handleSlideToRight
      }) : null;
      ...
      return _react2.default.Children.map(children, function (child, index) {
        return _react2.default.cloneElement(child, {
          style: _extends({}, child.props.style, _this.sildeStyle(index))
        });
      });
  ...
  _createClass(Slides, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'react-infinite-slides container', style: containerStyle },
...
Slides.propTypes = {
  ...
  arrowLeft: _propTypes2.default.element,
  arrowRight: _propTypes2.default.element,
  dots: _propTypes2.default.object
};
...
var EventSubscriptionVendor = __webpack_require__(56);
